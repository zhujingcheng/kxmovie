...
- (void) setupPresentView
{
    ...
    if (_decoder.validVideo) {
        _glView = [[KxMovieGLView alloc] initWithFrame:CGRectMake(0, 20,bounds.size.width ,200) decoder:_decoder];
        _glView2 = [[KxMovieGLView alloc] initWithFrame:CGRectMake(0, 240,bounds.size.width,200) decoder:_decoder];
    } 
    ...
    UIView *frameView2 = [self frameView2];
    frameView2.contentMode = UIViewContentModeScaleAspectFit;
    frameView2.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleBottomMargin;
    
    [self.view insertSubview:frameView2 atIndex:0];
...
- (UIView *) frameView2
{
    return _glView2 ? _glView2 : _imageView;
}
